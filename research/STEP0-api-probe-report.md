...
- 実行日: 2026-09-13
- 取得できた最新の日付: **2026-06-18**
- 実行日との差: **約 87 日（12.4 週）**
- この差は「配信遅延」ではなく、**契約終了日（2026-06-21）が実行日より過去であること**が主因の可能性が高い。契約の更新・プラン確認が必要。
