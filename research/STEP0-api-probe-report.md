...
| 2024-09-02 | ✅ あり |
| 2024-10-01 | ✅ あり |
| 2024-11-01 | — なし（HTTP 429・`(空またはJSON以外)`） |
| 2024-12-02 | — なし（HTTP 429・`(空またはJSON以外)`） |
| 2025-01-01 | — なし（HTTP 429・`(空またはJSON以外)`） |
| 2025-02-03 | — なし |
| 2025-03-03 | — なし |
| 2025-04-01 | — なし |
| 2025-05-01 | — なし |
...
- 探索範囲内（直近60営業日）に取得できるデータが見つからなかった。
...
- localhost:18081 への接続: **成功**
- `KABU_API_PASSWORD`: (設定あり・12文字・値は非表示)
- APIトークンの発行: **成功**（トークンは非表示）
- → 0-8 は疎通確認済みとしてよい
